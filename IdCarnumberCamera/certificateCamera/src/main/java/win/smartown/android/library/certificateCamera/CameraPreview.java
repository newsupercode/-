...
import win.smartown.android.library.certificateCamera.AutoFocusManager;
import win.smartown.android.library.certificateCamera.CameraUtils;
import win.smartown.android.library.certificateCamera.SensorControler;
    ...
    void setFocallength(int progress) {
        ...
        if (this.camera != null) {
            ...
            if (parameters.isZoomSupported()) {
                ...
                Toast.makeText(mContext, "不支持调焦", Toast.LENGTH_LONG).show();
            }
        }
    }
